  ...
  var e = {
                ...
                (i.apply = function (e, t, n) {
                  let s,
                    ...
                    a = {
                      ...
                      call: () => (
                        (i = !0), (s = Reflect.apply(a.fn, a.this, a.args))
                      ),
                    },
      ...
      4043: function (e, t, r) {
        ...
        class a {
          ...
          createFrame(e) {
            return (
              e || (e = document.createElement('iframe')), new s.u(this, e)
            );
          }
          encodeUrl(e) {
            if (
          ...
          switch (r) {
            ...
            case 'script': {
              ...
              if ((0, c.Sp)('sourcemaps', t.base) && i) {
                ...
                let e = `${c.vc.globals.pushsourcemapfn}([${i.join(
                    ','
                  )}], "${s}");`,
                  t = /^\s*(['"])use strict\1;?/;
                r = t.test(r)
...
${r}`;
  ...
  (r.n = (e) => {
    ...
    (self.$scramjetVersion = { build: 'd8b9484', version: '1.0.2-dev' }),
    'document' in self &&
