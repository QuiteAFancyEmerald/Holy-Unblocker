(() => {
  var e = {
      ...
      2439: function (e, t, r) {
        ...
        function h(e, t) {
          let r = {
            ...
            p = [
              (0, u.nativeGetOwnPropertyDescriptor)(
          ...
          (e.Trap('Node.prototype.baseURI', {
            ...
            e.Proxy('Element.prototype.setAttribute', {
              apply(t) {
                ...
                i &&
                  ((t.args[1] = i.fn(s, e.meta, e.cookieStore)),
            ...
            e.Trap(
              ...
              ],
              {
                get(e) {
                  let t = e.get();
                  return (
                    t && (l.a3 in t || new c.ScramjetClient(t).hook()),
                    t
                  );
                },
              }
            ...
            e.Trap(
              ...
              ],
              {
                get(t) {
                  ...
                  return r
                    ? (l.a3 in r || new c.ScramjetClient(r).hook(), r.document)
                    : r;
                },
              }
            ),
      ...
      9227: function (e, t, r) {
        function n(e, t) {
          let r = {
              ...
              set: (t, r, s) => (
                t == n && console.log('SET', r, s, t === n),
                t.setItem(e.url.host + '@' + r, s),
                !0
              ),
              ownKeys: (t) =>
                Reflect.ownKeys(t)
          ...
          constructor(e) {
            ...
            ((this.meta = {
              ...
              get topFrameName() {
                ...
                for (; e.parent.window !== e.window && e.parent.window[n.a3]; )
                  e = e.parent.window;
              ...
              (i.construct = function (e, t, n) {
                let s,
                  ...
                  a = {
                    ...
                    call: () => (
                      (i = !0),
                      (s = Reflect.construct(a.fn, a.args, a.newTarget))
                    ),
                  };
                return (r.construct(a), i)
                  ? s
                  : Reflect.construct(a.fn, a.args, a.newTarget);
              }),
              r.apply &&
                (i.apply = function (e, t, n) {
                  let s,
                    ...
                    a = {
                      ...
                      call: () => (
                        (i = !0),
                        (s = Reflect.apply(a.fn, a.this, a.args))
                      ),
                    },
                  ...
                  Error.prepareStackTrace = function (e, t) {
                    if (
                      ...
                      !t[0]
                        .getFileName()
                        .startsWith(location.origin + d.vc.prefix)
                    )
      ...
      5146: function (e, t, r) {
        (r.r(t),
          r.d(t, { argdbg: () => i, default: () => a, enabled: () => s }));
        var n = r(7097);
        ...
        function a(e, t) {
          ((t.$scramerr = function (e) {
            ...
            (t.$scramdbg = function (e, t) {
              return (
                e && 'object' == typeof e && e.length > 0 && i(e),
                i(t),
                t
              );
            }),
          ...
          Object.defineProperty(t, n.vc.globals.rewritefn, {
            value: function (t) {
              return 'string' != typeof t
                ? t
                : (0, s.Z)(t, '(direct eval proxy)', e.meta);
            },
            writable: !1,
            configurable: !1,
          });
              ...
              apply(e) {
                (performance.now(),
                  (function (e) {
                    ...
                    if (!c)
                      return (
                        console.warn('failed to get rewrites for tag', n),
                        e.return(t)
                      );
                    let u = 0;
                    for (; u < c.length; )
                    ...
                    let h = c.slice(u, d),
                      ...
                      f = 0;
                    for (let e of h)
                      if (((p += t.slice(f, e.start - o)), 0 === e.type))
                        f = e.start + e.size - o;
        ...
        function i(e, t) {
          (e.Proxy('Worker', {
            ...
            e.Proxy('SharedWorker', {
              construct(t) {
                ((t.args[0] =
                  (0, s.dm)(t.args[0], e.meta) + '?dest=sharedworker'),
                  t.args[1] &&
            ...
            e.Proxy('Worklet.prototype.addModule', {
              apply(t) {
                t.args[0] &&
                  (t.args[0] = (0, s.dm)(t.args[0], e.meta) + '?dest=worklet');
              },
            }));
        }
      },
      7706: function (e, t, r) {
        ...
        function c(e, t) {
          (Object.defineProperty(t, i.vc.globals.wrapfn, {
            ...
            console.log(i.vc.globals.wrappropertybase),
            Object.defineProperty(
              t.Object.prototype,
              i.vc.globals.wrappropertybase + 'location',
              {
                get: function () {
            ...
            Object.defineProperty(
              t.Object.prototype,
              i.vc.globals.wrappropertybase + 'parent',
              {
                get: function () {
            ...
            Object.defineProperty(
              t.Object.prototype,
              i.vc.globals.wrappropertybase + 'top',
              {
                get: function () {
            ...
            Object.defineProperty(
              t.Object.prototype,
              i.vc.globals.wrappropertybase + 'eval',
              {
                get: function () {
      ...
      4043: function (e, t, r) {
        (r.r(t), r.d(t, { ScramjetController: () => a }));
        var n = r(7097),
          s = r(129),
          i = r(1762).Z;
        class a {
  ...
  `,
      ...
      302: function (e, t, r) {
        ...
        let a = [
          ...
          {
            fn: (e, t) =>
              e.startsWith('blob:') ? (0, i.Ag)(e) : (0, i.dm)(e, t),
            src: ['video', 'audio'],
          },
      ...
      7097: function (e, t, r) {
        ...
        let a = Function;
        function o() {
          ((n = a(`return ${i.codec.encode}`)()),
            (s = a(`return ${i.codec.decode}`)()));
        }
        function l(e, t) {
          let r = i.flags[e];
      ...
      5701: function (e, t, r) {
        ...
        function a(e, t, r) {
          return (t = (t = (t = new String(t).toString()).replace(
            ...
            (t, s) => {
              let i =
                'rewrite' === e ? (0, n.dm)(s.trim(), r) : (0, n.Sd)(s.trim());
          ...
          let g = performance.now(),
            m = (function (e, t, r, c = !1) {
              ...
              if (
                ...
                (e ||
                  ((e = new s.W_('head', {}, [])), d.root.children.unshift(e)),
                  e.children.unshift(
                    ...h(t, (e) => new s.W_('script', { src: e }))
                  ));
              }
              return (0, i.Z)(d.root, {
                encodeEntities: 'utf8',
	...
	`);
            return (
              'string' == typeof e || (t = new TextEncoder().encode(t)),
              { js: t, tag: '', map: null }
            );
          }
            ...
            try {
              ...
              if (
                ((0, n.Sp)('sourcemaps', r.base) &&
                  !globalThis.clients &&
                  (globalThis[n.vc.globals.pushsourcemapfn](Array.from(d), h),
                  (d = null)),
      ...
      2434: function (e, t, r) {
        ...
        function l(e, t) {
          if (
            ...
            return (
              'javascript:' + (0, s.Z)(e.slice(11), '(javascript: url)', t)
            );
          {
        ...
        function c(e) {
          ...
          if (e.startsWith('javascript:')) return e;
          {
            ...
            return (
              (r.hash = ''),
              (0, n._h)(r.href.slice(t.length) + (s ? '#' + s : ''))
            );
          }
        }
      },
      522: function (e, t, r) {
        ...
        async function d() {
          n = new Uint8Array(
            await fetch(i.vc.files.wasm).then((e) => e.arrayBuffer())
          );
        }
        self.WASM &&
...
`);
          ...
          (l('wasm'),
            l('all'),
            (a += `$scramjetLoadClient(${JSON.stringify(n.vc)});`));
          let c = (0, s.Z)(e, r, i, o);
          return (
...
self.WASM = '${r}';`),
            ...
            if (
              ...
              ((n.finalURL = r.startsWith('blob:') ? r : '(data url)'),
                n.body &&
                  (t = await y(n, p, e.destination, u, this.cookieStore)));
            ...
            if (t && new URL(t.url).pathname.startsWith(c.vc.prefix)) {
              ...
              e.toString().includes('youtube.com') ||
                (b.set('Referer', e.href), b.set('Origin', e.origin));
            }
            ...
            v
              ? (b.set('Sec-Fetch-Dest', 'document'),
                b.set('Sec-Fetch-Mode', 'navigate'))
              : (b.set('Sec-Fetch-Dest', e.destination || 'empty'),
                b.set('Sec-Fetch-Mode', e.mode));
            let x = 'none';
            if (
              e.referrer &&
              '' !== e.referrer &&
            ...
            (await (0, i.W_)(
              h.toString(),
              e.referrer ? (0, a.Sd)(e.referrer) : null,
              x
            ),
              b.set('Sec-Fetch-Site', await (0, i.JN)(h.toString(), x)));
        ...
        async function m(e, t, r, n, o, l, c, d, h, p, f) {
          let g,
            m = 'navigate' === o && ['document', 'iframe'].includes(n),
            w = await (0, u.V)(l.rawHeaders, t, h, { get: i.Wq, set: i.N0 });
          if (
            (m &&
              w['referrer-policy'] &&
              f &&
              (await (0, i.N0)(e.href, w['referrer-policy'], f)),
            l.status >= 300 && l.status < 400 && w.location)
          ) {
            let t = new URL((0, a.Sd)(w.location));
            await (0, i.TE)(e.toString(), t.toString(), w['referrer-policy']);
            let n = await (0, s.$L)({ origin: t, base: t }, e, h);
          ...
          for (let t in (await c.setCookies(S instanceof Array ? S : [S], e),
          w))
            Array.isArray(w[t]) && (w[t] = w[t][0]);
          if (
            (l.body && (g = await y(l, t, n, r, c)),
            ['document', 'iframe'].includes(n))
          ) {
          ...
          ('text/event-stream' === w.accept &&
            (w['content-type'] = 'text/event-stream'),
            delete w['permissions-policy'],
            crossOriginIsolated &&
              [
                'document',
                'iframe',
              ...
              ((w['Cross-Origin-Embedder-Policy'] = 'require-corp'),
              (w['Cross-Origin-Opener-Policy'] = 'same-origin')));
          let v = new b(g, w, l.status, l.statusText, n, e, l, d);
          return (
            p.dispatchEvent(v),
            (l.status >= 300 && l.status < 400) ||
              (await (0, i.UX)(e.toString())),
            new Response(v.responseBody, {
...
${r}`;
        ...
        class g {
          constructor(e, t = {}) {
            ...
            ((this.options = t),
              ...
              (this.tokenizer = new (null != (a = t.Tokenizer) ? a : n.Z)(
                this.options,
                this
              )),
        ...
        class p {
          constructor({ xmlMode: e = !1, decodeEntities: t = !0 }, r) {
            ((this.cbs = r),
              ...
              (this.entityDecoder = new c.PQ(e ? c.mP : c.HP, (e, t) =>
          ...
          isTagStartChar(e) {
            return this.xmlMode
              ? !d(e)
              : (e >= a.LowerA && e <= a.LowerZ) ||
                  (e >= a.UpperA && e <= a.UpperZ);
          }
          startSpecial(e, t) {
            ((this.isSpecial = !0),
            ...
            e === t || (!this.decodeEntities && this.fastForwardTo(t))
              ? (this.cbs.onattribdata(this.sectionStart, this.index),
                ...
                this.cbs.onattribend(
                  t === a.DoubleQuote ? l.Double : l.Single,
                  this.index + 1
                ),
                (this.state = o.BeforeAttributeName))
              : this.decodeEntities && e === a.Amp && this.startEntity();
  ...
  ((r.n = (e) => {
    ...
    (self.$scramjetVersion = { build: 'ec0c298', version: '1.0.2-dev' }),
    'document' in self &&
