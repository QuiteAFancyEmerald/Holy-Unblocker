...
function keyboard(callback, event){
	...
	switch(event.keyCode){
		...
		case 68: // 'd' - qwerty, dvorak
		case 81: // 'q' - azerty
			callback(player, jsnes.Controller.BUTTON_A); break;
		case 67: // 'c' - qwerty, azerty
		case 79: // 'o' - dvorak
			callback(player, jsnes.Controller.BUTTON_B); break;
		case 32: // Space (changed from tab 9 because buggy)
...
function nes_load_url(){
	if(window.location.hash){
		var romloc = "./roms/" + window.location.hash.substring(1) + ".nes";
...
function setSmooth(){
	...
	var canvi = document.getElementById("nes-canvas");
	if (chekd == true){
